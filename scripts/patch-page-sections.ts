...
function buildLayoutChrome() {
  return {
    ...
    socialFacebook: L("socialFab", "facebook"),
    socialYoutube: L("socialFab", "youtube"),
...
async function main() {
  ...
  await mergeSingleton("homePage", "homePage", {
    ...
    servicesSection: {
      ...sectionHeader("home", "servicesTitle", "servicesSubtitle"),
      enabled: false,
    },
    newsSection: {
      ...sectionHeader("home", "newProducts", "newProductsSubtitle", {
        viewAllLabel: L("home", "viewAllArticles"),
      }),
      enabled: false,
    },
    clientLogosSection: {
      ...sectionHeader("home", "clientsTitle"),
      enabled: false,
    },
