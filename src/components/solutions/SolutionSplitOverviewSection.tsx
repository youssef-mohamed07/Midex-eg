      ...
      <div className="mx-container">
        <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:gap-12 xl:gap-16">
          <RevealOnScroll className="order-2 lg:order-1">
            <div className="relative min-h-[320px] overflow-hidden rounded-[1.75rem] border border-midex-line/60 shadow-[0_24px_64px_rgba(9,61,94,0.12)] sm:min-h-[400px] lg:min-h-[560px] lg:rounded-[2rem] xl:min-h-[620px]">
              <Image
                src={image}
                alt={imageAlt}
                fill
