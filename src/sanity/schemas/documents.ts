...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "social",
      hidden: true,
      description: "Deprecated — MIDEX has no X account.",
    }),
    defineField({
      name: "twitterHandle",
...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      group: "cta",
      description:
        "Optional. Reorder homepage body sections without code changes. Use keys like partners, faq, quoteCta. Unknown keys are ignored; missing keys keep the default order.",
      of: [{ type: "string" }],
      options: {
        list: [
          { title: "Partners", value: "partners" },
          { title: "Featured quote", value: "featuredQuote" },
          { title: "Capabilities", value: "capabilities" },
          { title: "Exclusive partners", value: "exclusive" },
          { title: "Truvia", value: "truvia" },
...
export const partner = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Link",
      type: "string",
      description: "Optional product or category path, e.g. /products/category/piping-and-fitting",
    }),
    defineField({
      name: "kind",
      title: "Kind",
...
export const caseStudy = defineType({
  ...
  fields: [
    ...
    defineField({ name: "image", title: "Client logo", type: "imageWithAlt" }),
    defineField({
      name: "gallery",
      title: "Project gallery",
      type: "array",
      of: [{ type: "imageWithAlt" }],
      description: "Project photos shown below the hero on the case study page.",
    }),
...
export const uiMessages = defineType({
  ...
  fields: [
    defineField({
      ...
      validation: required,
      description:
        "Prefer editing Page documents and Site Settings → Nav & Footer first. Use UI Messages for shared chrome leftovers (empty states, rare labels).",
      options: {
        list: [
          { title: "nav", value: "nav" },
          { title: "footer", value: "footer" },
          { title: "socialFab", value: "socialFab" },
