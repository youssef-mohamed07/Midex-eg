...
return array(
	...
	'content'    => '<!-- wp:group {"layout":{"type":"constrained"},"className":"midex-contact-page"} -->
<div class="wp-block-group midex-contact-page"><!-- wp:columns {"className":"midex-contact-layout"} -->
<div class="wp-block-columns midex-contact-layout"><!-- wp:column {"width":"38%","className":"midex-contact-sidebar"} -->
<div class="wp-block-column midex-contact-sidebar" style="flex-basis:38%"><!-- wp:columns {"className":"midex-contact-grid"} -->
...
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:midex/request-quote /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->',
);
